...
Game.Launch=function()
{
	...
	Game.Init=function()
	{
		...
		Game.attachTooltip(l('topbarOrteil'),'<div style="padding:8px;width:250px;text-align:center;">Base to Coopers home page</div>','this');
		Game.attachTooltip(l('topbarDashnet'),'<div style="padding:8px;width:250px;text-align:center;">Back to our homepage!</div>','this');
		Game.attachTooltip(l('topbarTwitter'),'<div style="padding:8px;width:250px;text-align:center;">page2.</div>','this');
		Game.attachTooltip(l('topbarTumblr'),'<div style="padding:8px;width:250px;text-align:center;">yoube clone</div>','this');
		Game.attachTooltip(l('topbarPage4'),'<div style="padding:8px;width:250px;text-align:center;">page4</div>','this');
